...
* Die Pluginübersicht erkennt die GitHub-Aktualisierungen auch ohne neuere Version als unterstützt.
* Automatische Aktualisierungen lassen sich dort regulär aktivieren und deaktivieren.

= 1.2.5 =

* Neue GitHub-Releases werden von WordPress erkannt und automatisch installiert.
* Ausschließlich veröffentlichte Releases mit dem erwarteten installierbaren ZIP werden akzeptiert.

= 1.2.4 =

* Zeitkorrektur je Kalender zum Ausgleich fehlerhaft verschobener Termine.
* Ganztägige Termine bleiben von der Zeitkorrektur unberührt.

= 1.2.3 =

* Die Sperre des Schleifenblocks umfasst nur noch den direkten Termin-Vorlagenblock und ersetzt keine individuell verschachtelten Inhalte.

= 1.2.2 =

* Individuell verschachtelte Termin-Vorlagen mit Zeilen, Stapeln und anderen Blöcken bleiben nach erneutem Öffnen des Editors erhalten.
